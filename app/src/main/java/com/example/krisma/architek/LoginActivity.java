...
import com.example.krisma.architek.asynctasks.Tools;
...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
     ...
     */
    private AsyncUserLogin mAuthTask = null;
    ...
    public void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new AsyncUserLogin(this);
    ...
    public void setmAuthTask(AsyncUserLogin mAuthTask) {
